...
class Test_TrialOrder
{
	...
	public function test4() {
		...
		trace("testTrialNames	", testTrialNames);
		trace("testProps ("+testProps.length+")		", testProps);
